            ...
            <div class="col-lg-8 col-md-12">
                <div class="ne-isotope">
                    <div class="topic-border color-scampi mb-30">
                        <div class="topic-box-lg color-scampi">Search Results:</div>
                    </div>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12">
                                <div class="media media-none--lg mb-30">
                                    <div class="position-relative width-40">
                                        <a href="{{ route('post', $search->id) }}" class="img-opacity-hover">
                                            <img src="{{ asset('news/storage/app/public/'.$search->image) }}" alt="news" style="width: 262px; height: 151px;">
                                        </a>
                                    </div>
                                        ...
                                        <div class="post-date-dark">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    </span>{{ $search->visitors }}
                                                </li>
                                            </ul>
                                        </div>
                                        <h3 class="title-semibold-dark size-lg mb-15">
                                            <a href="{{ route('post', $search->id) }}">{{ Str::limit($search->title, 70, '...') }}</a>
                                        </h3>
                                        <p>{{ strip_tags(html_entity_decode(Str::limit($search->desc_ka, 135))) }} </p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
